...
Deno.test("selects flags relevant to header parsing", () => {
  assertSame(headerCompilerFlags(["-Iinclude", "-DDEBUG", "-UNDEBUG", "-isystemvendor", "-Llib", "-lm"], "/project"), [
    "-I/project/include",
    "-DDEBUG",
    "-UNDEBUG",
...
Deno.test("preserves absolute and empty joined header paths", () => {
  assertSame(headerCompilerFlags(["-I/usr/include", "-I", "-isystem/opt/include", "-isystem"], "/project"), [
    "-I/usr/include",
    "-I",
    "-isystem/opt/include",
    "-isystem",
