import type { AssignmentStmt, BlockStmt, IfStmt, Statement, VarDeclStmt, WhileStmt } from "./ast.ts";
import type { CastAssignmentStmt, CastBlockStmt, CastIfStmt, CastStatement, CastVarDeclStmt, CastWhileStmt } from "./cast.ts";
