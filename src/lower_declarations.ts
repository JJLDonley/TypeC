import type { FunctionDecl, ImportDecl, Param, TypeAliasDecl } from "./ast.ts";
import type { CastFunctionDecl, CastImportDecl, CastParam, CastTypeAliasDecl } from "./cast.ts";
